...
public class FileCheckTask {
	...
	//("초 분 시 일 월 요일 (년도))
	//ex) 2주, 4주의 목요일 02시 마다(24시간제)
	//"0 0 2 * * 4#2 4$4"
	@Autowired
	AttachMapper attachMapper;
	
	@Scheduled(cron = "0 0 2 * * *")//매일 새벽 2시에 하겠다는뜻
	public void check(){
		log.warn("file check");
	}
	...
	public void checkFiles(){
		...
		log.warn("=========  FS의 폴더 내 모든 파일목록 중 DB와 일치 하지 않는 파일 목록 ===============");
